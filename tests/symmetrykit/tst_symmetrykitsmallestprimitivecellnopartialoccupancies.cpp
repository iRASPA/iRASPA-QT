...
static inline bool qFuzzyCompare(double3x3 p1, double3x3 p2, double epsilon = 1e-5)
{
...
SmallestPrimitiveCellNoPartialOccupancies::SmallestPrimitiveCellNoPartialOccupancies()
{
}
...
void SmallestPrimitiveCellNoPartialOccupancies::initTestCase()
{

}

void SmallestPrimitiveCellNoPartialOccupancies::cleanupTestCase()
{
