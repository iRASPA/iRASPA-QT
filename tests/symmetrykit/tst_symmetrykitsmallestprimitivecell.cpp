...
SmallestPrimitiveCell::SmallestPrimitiveCell()
{
}
...
void SmallestPrimitiveCell::initTestCase()
{

}

void SmallestPrimitiveCell::cleanupTestCase()
{
...
void SmallestPrimitiveCell::test_case_triclinic()
{
  ...
  for(auto &[fileName, unitCellTargetValue]: testData)
  {
    ...
    if (file.open(QIODevice::ReadOnly | QIODevice::Text))
    {
      ...
      if(DelaunayCell)
      {
        QVERIFY2(qFuzzyCompare(*DelaunayCell, unitCellTargetValue, symmetryPrecision), (QString("Smallest primitive error for file: ") + fileName).toStdString().c_str());
      }
      else
      {
        QFAIL((QString("\nDelaunay Error for file: ") + fileName).toStdString().c_str());
      }
...
void SmallestPrimitiveCell::test_case_monoclinic()
{
  const std::map<QString, double3x3> testData =
  {
  ...
  for(auto &[fileName, unitCellTargetValue]: testData)
  {
    ...
    if (file.open(QIODevice::ReadOnly | QIODevice::Text))
    {
      ...
      if(DelaunayCell)
      {
        bool compare = qFuzzyCompare(*DelaunayCell, unitCellTargetValue, symmetryPrecision);
        QVERIFY2(compare, (QString("Smallest primitive error for file: ") + fileName).toStdString().c_str());
...
void SmallestPrimitiveCell::test_case_orthorhombic()
{
  const std::map<QString, double3x3> testData =
  {
...
void SmallestPrimitiveCell::test_case_tetragonal()
{
  const std::map<QString, double3x3> testData =
  {
...
void SmallestPrimitiveCell::test_case_trigonal()
{
  const std::map<QString, double3x3> testData =
  {
...
void SmallestPrimitiveCell::test_case_hexagonal()
{
  const std::map<QString, double3x3> testData =
  {
  ...
  for(auto &[fileName, unitCellTargetValue]: testData)
  {
    ...
    if (file.open(QIODevice::ReadOnly | QIODevice::Text))
    {
      ...
      std::vector<std::tuple<double3, int, double> > reducedAtoms = parser.firstTestFrame();
      std::vector<std::tuple<double3, int, double> > atoms = parser.firstTestFrame();
      double3x3 unitCell = parser.movies().front().front()->cell->unitCell();
      bool allowPartialOccupancies = true;
      double symmetryPrecision=1e-5;
...
void SmallestPrimitiveCell::test_case_cubic()
{
  const std::map<QString, double3x3> testData =
  {
...
void SmallestPrimitiveCell::test_case_virtual()
{
  const std::map<QString, double3x3> testData =
  {
