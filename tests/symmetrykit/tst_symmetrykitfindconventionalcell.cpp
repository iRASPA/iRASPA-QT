...
FindConventionalCell::FindConventionalCell()
{
}
...
void FindConventionalCell::initTestCase()
{

}

void FindConventionalCell::cleanupTestCase()
{

}


void FindConventionalCell::test_case_triclinic()
{
  ...
  for(auto &[fileName, conventionalCellTargetValue]: testData)
  {
    ...
    if (file.open(QIODevice::ReadOnly | QIODevice::Text))
    {
      ...
      if(spaceGroup)
      {
        ...
        if(!(foundConventionalCell == conventionalCellTargetValue))
        {
          qDebug() << fileName << foundConventionalCell << " vs. " << conventionalCellTargetValue;
        }
        QCOMPARE(foundConventionalCell, conventionalCellTargetValue);
      }
      else
      {
...
void FindConventionalCell::test_case_monoclinic()
{
  srand((unsigned) time(nullptr));
...
void FindConventionalCell::test_case_orthorhombic()
{
  srand((unsigned) time(nullptr));
...
void FindConventionalCell::test_case_tetragonal()
{
  srand((unsigned) time(nullptr));
...
void FindConventionalCell::test_case_trigonal()
{
  srand((unsigned) time(nullptr));
...
void FindConventionalCell::test_case_hexagonal()
{
  srand((unsigned) time(nullptr));
...
void FindConventionalCell::test_case_cubic()
{
  srand((unsigned) time(nullptr));
...
void FindConventionalCell::test_case_virtual()
{
  srand((unsigned) time(nullptr));
