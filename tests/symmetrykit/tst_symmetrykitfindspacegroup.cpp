...
void FindSpaceGroup::initTestCase()
{

}

void FindSpaceGroup::cleanupTestCase()
{

}


void FindSpaceGroup::test_case_triclinic()
{
...
void FindSpaceGroup::test_case_monoclinic()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroup::test_case_orthorhombic()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroup::test_case_tetragonal()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroup::test_case_trigonal()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroup::test_case_hexagonal()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroup::test_case_cubic()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroup::test_case_virtual()
{
  srand((unsigned) time(nullptr));
