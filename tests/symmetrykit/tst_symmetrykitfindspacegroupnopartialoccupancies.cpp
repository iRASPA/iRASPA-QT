...
FindSpaceGroupNoPartialOccupancies::FindSpaceGroupNoPartialOccupancies()
{
}
...
void FindSpaceGroupNoPartialOccupancies::initTestCase()
{

}

void FindSpaceGroupNoPartialOccupancies::cleanupTestCase()
{

}


void FindSpaceGroupNoPartialOccupancies::test_case_triclinic()
{
  ...
  for(auto &[fileName, spaceGroupTargetValue]: testData)
  {
    ...
    if (file.open(QIODevice::ReadOnly | QIODevice::Text))
    {
      ...
      if(spaceGroup)
      {
        ...
        if(foundSpaceGroup.spaceGroupSetting().number()!= spaceGroupTargetValue)
        {
          qDebug() << fileName << foundSpaceGroup.spaceGroupSetting().number() << " vs. " << spaceGroupTargetValue;
        }
        QCOMPARE(foundSpaceGroup.spaceGroupSetting().number(), spaceGroupTargetValue);
      }
      else
      {
...
void FindSpaceGroupNoPartialOccupancies::test_case_monoclinic()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroupNoPartialOccupancies::test_case_orthorhombic()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroupNoPartialOccupancies::test_case_tetragonal()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroupNoPartialOccupancies::test_case_trigonal()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroupNoPartialOccupancies::test_case_hexagonal()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroupNoPartialOccupancies::test_case_cubic()
{
  srand((unsigned) time(nullptr));
...
void FindSpaceGroupNoPartialOccupancies::test_case_virtual()
{
  srand((unsigned) time(nullptr));
