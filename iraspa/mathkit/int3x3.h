...
union int3x3
{
  ...
  inline union int3x3& operator+= (const union int3x3& b) { this->m11 += b.m11; this->m21 += b.m21; this->m31 += b.m31;
  ...
  inline bool operator==(const union int3x3& b) const {return (this->m11 == b.m11) && (this->m21 == b.m21) && (this->m31 == b.m31) &&
                                                              (this->m12 == b.m12) && (this->m22 == b.m22) && (this->m32 == b.m32) &&
                                                              (this->m13 == b.m13) && (this->m23 == b.m23) && (this->m33 == b.m33);}
...
inline union int3x3 operator+(const union int3x3 &a, const union int3x3& b)
{
  union int3x3 r;
...
inline int3x3 operator*(const union int3x3 &a, const union int3x3& b)
{
  union int3x3 r;
...
inline int3 operator*(const union int3x3 &a, const int3& b)
{
  int3 r(0,0,0);
...
inline double3 operator*(const union int3x3 &a, const double3& b)
{
  double3 r(0,0,0);
...
inline union int3x3 operator / (const union int3x3 &a, const int& b)
{
  union int3x3 r;
