...
class OpenGLPolygonalPrismObjectSelectionStripesShader: public OpenGLShader
{
public:
  OpenGLPolygonalPrismObjectSelectionStripesShader(OpenGLPolygonalPrismSelectionInstanceShader &instanceShader, OpenGLPolygonalPrismObjectShader &polygonalPrismShader);
