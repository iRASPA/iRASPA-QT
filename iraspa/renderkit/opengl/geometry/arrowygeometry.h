...
class ArrowYGeometry
{
public:
  ArrowYGeometry(double offset, double arrowHeight, double arrowRadius, float4 arrowColor, double tipHeight, double tipRadius, float4 tipColor, bool tipVisibility, double aspectRatio, int sectorCount);
