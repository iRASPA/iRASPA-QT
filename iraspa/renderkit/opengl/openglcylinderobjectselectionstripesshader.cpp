...
OpenGLCylinderObjectSelectionStripesShader::OpenGLCylinderObjectSelectionStripesShader(OpenGLCylinderSelectionInstanceShader &instanceShader, OpenGLCylinderObjectShader &cylinderShader):
...
void OpenGLCylinderObjectSelectionStripesShader::paintGL(GLuint structureUniformBuffer)
{
...
void OpenGLCylinderObjectSelectionStripesShader::deleteBuffers()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
...
void OpenGLCylinderObjectSelectionStripesShader::generateBuffers()
{
...
void OpenGLCylinderObjectSelectionStripesShader::reloadData()
{
  initializeVertexArrayObject();
}

void OpenGLCylinderObjectSelectionStripesShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
...
void OpenGLCylinderObjectSelectionStripesShader::loadShader(void)
{
  GLuint vertexShader;
  GLuint fragmentShader;

  vertexShader=compileShaderOfType(GL_VERTEX_SHADER, OpenGLCylinderObjectSelectionStripesShader::_vertexShaderSource.c_str());
  fragmentShader=compileShaderOfType(GL_FRAGMENT_SHADER, OpenGLCylinderObjectSelectionStripesShader::_fragmentShaderSource.c_str());
...
const std::string OpenGLCylinderObjectSelectionStripesShader::_vertexShaderSource  =
...
const std::string OpenGLCylinderObjectSelectionStripesShader::_fragmentShaderSource =
OpenGLVersionStringLiteral +
OpenGLFrameUniformBlockStringLiteral +
OpenGLStructureUniformBlockStringLiteral +
OpenGLLightUniformBlockStringLiteral +
