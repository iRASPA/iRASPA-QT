...
class OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader: public OpenGLShader
{
public:
  OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader(OpenGLPolygonalPrismSelectionInstanceShader &instanceShader, OpenGLPolygonalPrismObjectShader &polygonalPrismShader);
...
private:
  OpenGLPolygonalPrismSelectionInstanceShader &_instanceShader;
  OpenGLPolygonalPrismObjectShader &_polygonalPrismShader;
  GLuint _program;
