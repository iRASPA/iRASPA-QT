...
OpenGLEllipsoidSelectionInstanceShader::OpenGLEllipsoidSelectionInstanceShader()
{
...
void OpenGLEllipsoidSelectionInstanceShader::deleteBuffers()
{
...
void OpenGLEllipsoidSelectionInstanceShader::generateBuffers()
{
...
void OpenGLEllipsoidSelectionInstanceShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
    {
      ...
      {
        std::vector<RKInPerInstanceAttributesAtoms> atomData = object->renderSelectedPrimitiveEllipsoidObjects();
...
void OpenGLEllipsoidSelectionInstanceShader::reloadData()
{
