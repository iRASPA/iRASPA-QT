...
class OpenGLObjectSelectionShader;

class OpenGLObjectShader: public QOpenGLFunctions_3_3_Core
{
public:
  OpenGLObjectShader();
...
private:
  ...
  friend OpenGLCylinderObjectPickingShader;
  friend OpenGLPolygonalPrismObjectPickingShader;

  friend OpenGLObjectSelectionShader;
};
