...
class OpenGLCrystalEllipseObjectPickingShader: public OpenGLShader
{
public:
  OpenGLCrystalEllipseObjectPickingShader(OpenGLObjectShader &objectShader);
...
private:
  OpenGLCrystalEllipseObjectShader& _crystalEllipseShader;
  GLuint _program;
