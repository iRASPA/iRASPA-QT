...
OpenGLCrystalCylinderSelectionInstanceShader::OpenGLCrystalCylinderSelectionInstanceShader()
{

}

void OpenGLCrystalCylinderSelectionInstanceShader::setRenderStructures(std::vector<std::vector<std::shared_ptr<RKRenderStructure>>> structures)
{
  deleteBuffers();
...
void OpenGLCrystalCylinderSelectionInstanceShader::deleteBuffers()
{
...
void OpenGLCrystalCylinderSelectionInstanceShader::generateBuffers()
{
...
void OpenGLCrystalCylinderSelectionInstanceShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
    {
      ...
      {
        std::vector<RKInPerInstanceAttributesAtoms> atomData = object->renderSelectedCrystalPrimitiveCylinderObjects();
...
void OpenGLCrystalCylinderSelectionInstanceShader::reloadData()
{
