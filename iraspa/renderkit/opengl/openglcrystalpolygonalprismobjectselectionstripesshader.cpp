...
OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::OpenGLCrystalPolygonalPrismObjectSelectionStripesShader(OpenGLCrystalPolygonalPrismSelectionInstanceShader &instanceShader, OpenGLCrystalPolygonalPrismObjectShader &crystalPolygonalPrismShader):
...
void OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::paintGL(GLuint structureUniformBuffer)
{
...
void OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::deleteBuffers()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
...
void OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::generateBuffers()
{
...
void OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::reloadData()
{
  initializeVertexArrayObject();
}

void OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
...
void OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::loadShader(void)
{
  GLuint vertexShader;
  GLuint fragmentShader;

  vertexShader=compileShaderOfType(GL_VERTEX_SHADER, OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::_vertexShaderSource.c_str());
  fragmentShader=compileShaderOfType(GL_FRAGMENT_SHADER, OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::_fragmentShaderSource.c_str());
...
const std::string OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::_vertexShaderSource  =
...
const std::string OpenGLCrystalPolygonalPrismObjectSelectionStripesShader::_fragmentShaderSource =
OpenGLVersionStringLiteral +
OpenGLFrameUniformBlockStringLiteral +
OpenGLStructureUniformBlockStringLiteral +
OpenGLLightUniformBlockStringLiteral +
