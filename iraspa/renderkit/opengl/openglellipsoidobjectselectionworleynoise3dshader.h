...
class OpenGLEllipsoidObjectSelectionWorleyNoise3DShader: public OpenGLShader
{
public:
  OpenGLEllipsoidObjectSelectionWorleyNoise3DShader(OpenGLEllipsoidSelectionInstanceShader &instanceShader, OpenGLEllipseObjectShader &ellipsoidShader);
...
private:
  OpenGLEllipsoidSelectionInstanceShader &_instanceShader;
  OpenGLEllipseObjectShader &_ellipsoidShader;
  GLuint _program;
