...
void OpenGLEnergyVolumeRenderedSurface::initializeTransferFunctionTexture()
{
  ...
  glDeleteTextures(1.0f, &_transferFunctionTexture);
  check_gl_error();
  // All texture names will be nonzero, unsigned integers.
  glGenTextures(1.0f, &_transferFunctionTexture);
  check_gl_error();
  glBindTexture(GL_TEXTURE_1D_ARRAY, _transferFunctionTexture);
...
std::array<float4, 256> OpenGLEnergyVolumeRenderedSurface::RASPA_PES_TransferFunction
{
  ...
  float4(1.0f, 1, 0, 0),
  float4(1.0f, 1, 0, 0),
  float4(1.0f, 0.994764, 0.00392727, 0),
  float4(1.0f, 0.985455, 0.0109091, 0),
  float4(1.0f, 0.976145, 0.0178909, 0),
  float4(1.0f, 0.966836, 0.0248727, 0),
  float4(1.0f, 0.957527, 0.0318545, 0),
  float4(1.0f, 0.948218, 0.0388364, 0),
  float4(1.0f, 0.938909, 0.0458182, 0),
  float4(1.0f, 0.9296, 0.0528, 0),
  float4(1.0f, 0.920291, 0.0597818, 0),
  float4(1.0f, 0.910982, 0.0667636, 0),
  float4(1.0f, 0.901673, 0.0737455, 0),
  float4(1.0f, 0.892364, 0.0807273, 0),
  float4(1.0f, 0.883055, 0.0877091, 0),
  float4(1.0f, 0.873745, 0.0946909, 0),
  float4(1.0f, 0.864436, 0.101673, 0),
  float4(1.0f, 0.855127, 0.108655, 0),
  float4(1.0f, 0.845818, 0.115636, 0.0288),
  float4(1.0f, 0.836509, 0.122618, 0.05952),
  float4(1.0f, 0.8272, 0.1296, 0.09024),
  float4(1.0f, 0.817891, 0.136582, 0.12096),
  float4(1.0f, 0.808582, 0.143564, 0.15168),
  float4(1.0f, 0.799273, 0.150545, 0.1824),
  float4(1.0f, 0.789964, 0.157527, 0.21312),
  float4(1.0f, 0.780655, 0.164509, 0.24384),
  float4(1.0f, 0.771345, 0.171491, 0.27456),
  float4(1.0f, 0.762036, 0.178473, 0.30528),
  float4(1.0f, 0.752727, 0.185455, 0.336),
  float4(1.0f, 0.743418, 0.192436, 0.36672),
  float4(1.0f, 0.734109, 0.199418, 0.39744),
  float4(1.0f, 0.7248, 0.2064, 0.42816),
  float4(1.0f, 0.715491, 0.213382, 0.45888),
  float4(1.0f, 0.706182, 0.220364, 0.4896),
  float4(1.0f, 0.696873, 0.227345, 0.52032),
  float4(1.0f, 0.687564, 0.234327, 0.55104),
  float4(1.0f, 0.678255, 0.241309, 0.58176),
  float4(1.0f, 0.668945, 0.248291, 0.6),
  float4(1.0f, 0.659636, 0.255273, 0.6),
  float4(1.0f, 0.650327, 0.262255, 0.6),
  float4(1.0f, 0.641018, 0.269236, 0.6),
  float4(1.0f, 0.631709, 0.276218, 0.6),
  float4(1.0f, 0.6224, 0.2832, 0.6),
  float4(1.0f, 0.613091, 0.290182, 0.6),
  float4(1.0f, 0.603782, 0.297164, 0.6),
  float4(1.0f, 0.605527, 0.295855, 0.6),
  float4(1.0f, 0.614836, 0.288873, 0.6),
  float4(1.0f, 0.624145, 0.281891, 0.6),
  float4(1.0f, 0.633455, 0.274909, 0.6),
  float4(1.0f, 0.642764, 0.267927, 0.6),
  float4(1.0f, 0.652073, 0.260945, 0.6),
  float4(1.0f, 0.661382, 0.253964, 0.6),
  float4(1.0f, 0.670691, 0.246982, 0.6),
  float4(1.0f, 0.68, 0.24, 0.6),
  float4(1.0f, 0.689309, 0.233018, 0.6),
  float4(1.0f, 0.698618, 0.226036, 0.6),
  float4(1.0f, 0.707927, 0.219055, 0.6),
  float4(1.0f, 0.717236, 0.212073, 0.60672),
  float4(1.0f, 0.726545, 0.205091, 0.6144),
  float4(1.0f, 0.735855, 0.198109, 0.62208),
  float4(1.0f, 0.745164, 0.191127, 0.62976),
  float4(1.0f, 0.754473, 0.184145, 0.63744),
  float4(1.0f, 0.763782, 0.177164, 0.64512),
  float4(1.0f, 0.773091, 0.170182, 0.6528),
  float4(1.0f, 0.7824, 0.1632, 0.66048),
  float4(1.0f, 0.791709, 0.156218, 0.66816),
  float4(1.0f, 0.801018, 0.149236, 0.67584),
  float4(1.0f, 0.810327, 0.142255, 0.68352),
  float4(1.0f, 0.819636, 0.135273, 0.6912),
  float4(1.0f, 0.828945, 0.128291, 0.69888),
  float4(1.0f, 0.838255, 0.121309, 0.70656),
  float4(1.0f, 0.847564, 0.114327, 0.71424),
  float4(1.0f, 0.856873, 0.107345, 0.72192),
  float4(1.0f, 0.866182, 0.100364, 0.7296),
  float4(1.0f, 0.875491, 0.0933818, 0.73728),
  float4(1.0f, 0.8848, 0.0864, 0.74496),
  float4(1.0f, 0.894109, 0.0794182, 0.75264),
  float4(1.0f, 0.903418, 0.0724364, 0.76032),
  float4(1.0f, 0.912727, 0.0654545, 0.768),
  float4(1.0f, 0.922036, 0.0584727, 0.77568),
  float4(1.0f, 0.931345, 0.0514909, 0.78336),
  float4(1.0f, 0.940655, 0.0445091, 0.79104),
  float4(1.0f, 0.949964, 0.0375273, 0.79872),
  float4(1.0f, 0.959273, 0.0305455, 0.8064),
  float4(1.0f, 0.968582, 0.0235636, 0.81408),
  float4(1.0f, 0.977891, 0.0165818, 0.82176),
  float4(1.0f, 0.9872, 0.0096, 0.82944),
  float4(1.0f, 0.996509, 0.00261818, 0.83712),
