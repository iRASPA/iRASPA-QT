...
class OpenGLCrystalPolygonalPrismObjectSelectionGlowShader: public OpenGLShader
{
public:
  OpenGLCrystalPolygonalPrismObjectSelectionGlowShader(OpenGLCrystalPolygonalPrismSelectionInstanceShader &instanceShader, OpenGLCrystalPolygonalPrismObjectShader &crystalPolygonalPrismShader);
