...
class OpenGLCrystalCylinderObjectSelectionGlowShader: public OpenGLShader
{
public:
  OpenGLCrystalCylinderObjectSelectionGlowShader(OpenGLCrystalCylinderSelectionInstanceShader &instanceShader, OpenGLCrystalCylinderObjectShader &crystalCylinderShader);
