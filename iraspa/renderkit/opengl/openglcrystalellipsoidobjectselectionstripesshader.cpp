...
OpenGLCrystalEllipsoidObjectSelectionStripesShader::OpenGLCrystalEllipsoidObjectSelectionStripesShader(OpenGLCrystalEllipsoidSelectionInstanceShader &instanceShader, OpenGLCrystalEllipseObjectShader &crystalEllipsoidShader):
...
void OpenGLCrystalEllipsoidObjectSelectionStripesShader::paintGL(GLuint structureUniformBuffer)
{
...
void OpenGLCrystalEllipsoidObjectSelectionStripesShader::deleteBuffers()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
...
void OpenGLCrystalEllipsoidObjectSelectionStripesShader::generateBuffers()
{
...
void OpenGLCrystalEllipsoidObjectSelectionStripesShader::reloadData()
{
  initializeVertexArrayObject();
}

void OpenGLCrystalEllipsoidObjectSelectionStripesShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
...
void OpenGLCrystalEllipsoidObjectSelectionStripesShader::loadShader(void)
{
  GLuint vertexShader;
  GLuint fragmentShader;

  vertexShader=compileShaderOfType(GL_VERTEX_SHADER, OpenGLCrystalEllipsoidObjectSelectionStripesShader::_vertexShaderSource.c_str());
  fragmentShader=compileShaderOfType(GL_FRAGMENT_SHADER, OpenGLCrystalEllipsoidObjectSelectionStripesShader::_fragmentShaderSource.c_str());
...
const std::string OpenGLCrystalEllipsoidObjectSelectionStripesShader::_vertexShaderSource  =
...
const std::string OpenGLCrystalEllipsoidObjectSelectionStripesShader::_fragmentShaderSource =
OpenGLVersionStringLiteral +
OpenGLFrameUniformBlockStringLiteral +
OpenGLStructureUniformBlockStringLiteral +
OpenGLLightUniformBlockStringLiteral +
