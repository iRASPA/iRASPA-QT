...
class OpenGLGlobalAxesShader: public QOpenGLFunctions_3_3_Core
{
public:
  OpenGLGlobalAxesShader();
...
private:
  ...
  OpenGLGlobalAxesBackgroundShader _axesBackgroundShader;
  OpenGLGlobalAxesSystemShader _axesSystemShader;
  OpenGLGlobalAxesTextShader _axesTextShader;
