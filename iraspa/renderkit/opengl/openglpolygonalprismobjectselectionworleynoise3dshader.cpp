...
OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader(OpenGLPolygonalPrismSelectionInstanceShader &instanceShader, OpenGLPolygonalPrismObjectShader &polygonalPrismShader):
     _instanceShader(instanceShader), _polygonalPrismShader(polygonalPrismShader)
{
}


void OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::setRenderStructures(std::vector<std::vector<std::shared_ptr<RKRenderStructure>>> structures)
{
  deleteBuffers();
...
void OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::paintGL(GLuint structureUniformBuffer)
{
...
void OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::deleteBuffers()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
...
void OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::generateBuffers()
{
...
void OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::reloadData()
{
  initializeVertexArrayObject();
}

void OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
...
void OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::loadShader(void)
{
  GLuint vertexShader;
  GLuint fragmentShader;

  vertexShader=compileShaderOfType(GL_VERTEX_SHADER, OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::_vertexShaderSource.c_str());
  fragmentShader=compileShaderOfType(GL_FRAGMENT_SHADER, OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::_fragmentShaderSource.c_str());
...
const std::string OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::_vertexShaderSource  =
...
const std::string OpenGLPolygonalPrismObjectSelectionWorleyNoise3DShader::_fragmentShaderSource =
OpenGLVersionStringLiteral +
OpenGLFrameUniformBlockStringLiteral +
OpenGLStructureUniformBlockStringLiteral +
OpenGLLightUniformBlockStringLiteral +
