...
OpenGLCrystalEllipsoidObjectSelectionGlowShader::OpenGLCrystalEllipsoidObjectSelectionGlowShader(OpenGLCrystalEllipsoidSelectionInstanceShader &instanceShader, OpenGLCrystalEllipseObjectShader &crystalEllipsoidShader):
     _instanceShader(instanceShader), _crystalEllipsoidShader(crystalEllipsoidShader)
{
}


void OpenGLCrystalEllipsoidObjectSelectionGlowShader::setRenderStructures(std::vector<std::vector<std::shared_ptr<RKRenderStructure>>> structures)
{
  deleteBuffers();
...
void OpenGLCrystalEllipsoidObjectSelectionGlowShader::paintGL(GLuint structureUniformBuffer)
{
...
void OpenGLCrystalEllipsoidObjectSelectionGlowShader::deleteBuffers()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
...
void OpenGLCrystalEllipsoidObjectSelectionGlowShader::generateBuffers()
{
...
void OpenGLCrystalEllipsoidObjectSelectionGlowShader::reloadData()
{
  initializeVertexArrayObject();
}

void OpenGLCrystalEllipsoidObjectSelectionGlowShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
...
void OpenGLCrystalEllipsoidObjectSelectionGlowShader::loadShader(void)
{
  GLuint vertexShader;
  GLuint fragmentShader;

  vertexShader=compileShaderOfType(GL_VERTEX_SHADER, OpenGLCrystalEllipsoidObjectSelectionGlowShader::_vertexShaderSource.c_str());
  fragmentShader=compileShaderOfType(GL_FRAGMENT_SHADER, OpenGLCrystalEllipsoidObjectSelectionGlowShader::_fragmentShaderSource.c_str());
...
const std::string OpenGLCrystalEllipsoidObjectSelectionGlowShader::_vertexShaderSource  =
...
const std::string OpenGLCrystalEllipsoidObjectSelectionGlowShader::_fragmentShaderSource =
OpenGLVersionStringLiteral +
OpenGLFrameUniformBlockStringLiteral +
OpenGLStructureUniformBlockStringLiteral +
OpenGLLightUniformBlockStringLiteral +
