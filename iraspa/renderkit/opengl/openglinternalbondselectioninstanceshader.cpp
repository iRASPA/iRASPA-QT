...
OpenGLInternalBondSelectionInstanceShader::OpenGLInternalBondSelectionInstanceShader()
{
...
void OpenGLInternalBondSelectionInstanceShader::deleteBuffers()
{
...
void OpenGLInternalBondSelectionInstanceShader::generateBuffers()
{
...
void OpenGLInternalBondSelectionInstanceShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
...
void OpenGLInternalBondSelectionInstanceShader::reloadData()
{
