...
void OpenGLEllipsoidObjectSelectionStripesShader::paintGL(GLuint structureUniformBuffer)
{
...
void OpenGLEllipsoidObjectSelectionStripesShader::deleteBuffers()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
...
void OpenGLEllipsoidObjectSelectionStripesShader::generateBuffers()
{
...
void OpenGLEllipsoidObjectSelectionStripesShader::reloadData()
{
  initializeVertexArrayObject();
}

void OpenGLEllipsoidObjectSelectionStripesShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
...
void OpenGLEllipsoidObjectSelectionStripesShader::loadShader(void)
{
  GLuint vertexShader;
  GLuint fragmentShader;

  vertexShader=compileShaderOfType(GL_VERTEX_SHADER, OpenGLEllipsoidObjectSelectionStripesShader::_vertexShaderSource.c_str());
  fragmentShader=compileShaderOfType(GL_FRAGMENT_SHADER, OpenGLEllipsoidObjectSelectionStripesShader::_fragmentShaderSource.c_str());
