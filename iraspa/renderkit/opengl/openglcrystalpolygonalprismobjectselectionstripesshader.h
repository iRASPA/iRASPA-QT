...
class OpenGLCrystalPolygonalPrismObjectSelectionStripesShader: public OpenGLShader
{
public:
  OpenGLCrystalPolygonalPrismObjectSelectionStripesShader(OpenGLCrystalPolygonalPrismSelectionInstanceShader &instanceShader, OpenGLCrystalPolygonalPrismObjectShader &crystalPolygonalPrismShader);
