...
class OpenGLCylinderObjectSelectionWorleyNoise3DShader: public OpenGLShader
{
public:
  OpenGLCylinderObjectSelectionWorleyNoise3DShader(OpenGLCylinderSelectionInstanceShader &instanceShader, OpenGLCylinderObjectShader &cylinderShader);
...
private:
  OpenGLCylinderSelectionInstanceShader &_instanceShader;
  OpenGLCylinderObjectShader &_cylinderShader;
  GLuint _program;
