...
class OpenGLCrystalEllipsoidObjectSelectionWorleyNoise3DShader: public OpenGLShader
{
public:
  OpenGLCrystalEllipsoidObjectSelectionWorleyNoise3DShader(OpenGLCrystalEllipsoidSelectionInstanceShader &instanceShader, OpenGLCrystalEllipseObjectShader &crystalEllipsoidShader);
