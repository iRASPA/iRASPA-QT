...
class OpenGLCrystalEllipsoidObjectSelectionStripesShader: public OpenGLShader
{
public:
  OpenGLCrystalEllipsoidObjectSelectionStripesShader(OpenGLCrystalEllipsoidSelectionInstanceShader &instanceShader, OpenGLCrystalEllipseObjectShader &crystalEllipsoidShader);
