...
OpenGLCrystalCylinderObjectSelectionStripesShader::OpenGLCrystalCylinderObjectSelectionStripesShader(OpenGLCrystalCylinderSelectionInstanceShader &instanceShader, OpenGLCrystalCylinderObjectShader &crystalCylinderShader):
     _instanceShader(instanceShader), _crystalCylinderShader(crystalCylinderShader)
{
}


void OpenGLCrystalCylinderObjectSelectionStripesShader::setRenderStructures(std::vector<std::vector<std::shared_ptr<RKRenderStructure>>> structures)
{
  deleteBuffers();
...
void OpenGLCrystalCylinderObjectSelectionStripesShader::paintGL(GLuint structureUniformBuffer)
{
...
void OpenGLCrystalCylinderObjectSelectionStripesShader::deleteBuffers()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
...
void OpenGLCrystalCylinderObjectSelectionStripesShader::generateBuffers()
{
...
void OpenGLCrystalCylinderObjectSelectionStripesShader::reloadData()
{
  initializeVertexArrayObject();
}

void OpenGLCrystalCylinderObjectSelectionStripesShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
...
void OpenGLCrystalCylinderObjectSelectionStripesShader::loadShader(void)
{
  GLuint vertexShader;
  GLuint fragmentShader;

  vertexShader=compileShaderOfType(GL_VERTEX_SHADER, OpenGLCrystalCylinderObjectSelectionStripesShader::_vertexShaderSource.c_str());
  fragmentShader=compileShaderOfType(GL_FRAGMENT_SHADER, OpenGLCrystalCylinderObjectSelectionStripesShader::_fragmentShaderSource.c_str());
...
const std::string OpenGLCrystalCylinderObjectSelectionStripesShader::_vertexShaderSource  =
...
const std::string OpenGLCrystalCylinderObjectSelectionStripesShader::_fragmentShaderSource =
OpenGLVersionStringLiteral +
OpenGLFrameUniformBlockStringLiteral +
OpenGLStructureUniformBlockStringLiteral +
OpenGLLightUniformBlockStringLiteral +
