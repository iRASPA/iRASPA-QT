...
class OpenGLCrystalPolygonalPrismObjectSelectionWorleyNoise3DShader: public OpenGLShader
{
public:
  OpenGLCrystalPolygonalPrismObjectSelectionWorleyNoise3DShader(OpenGLCrystalPolygonalPrismSelectionInstanceShader &instanceShader, OpenGLCrystalPolygonalPrismObjectShader &crystalPolygonalPrismShader);
...
private:
  OpenGLCrystalPolygonalPrismSelectionInstanceShader &_instanceShader;
  OpenGLCrystalPolygonalPrismObjectShader &_crystalPolygonalPrismShader;
  GLuint _program;
