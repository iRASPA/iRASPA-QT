...
OpenGLCrystalPolygonalPrismSelectionInstanceShader::OpenGLCrystalPolygonalPrismSelectionInstanceShader()
{
...
void OpenGLCrystalPolygonalPrismSelectionInstanceShader::deleteBuffers()
{
...
void OpenGLCrystalPolygonalPrismSelectionInstanceShader::generateBuffers()
{
...
void OpenGLCrystalPolygonalPrismSelectionInstanceShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
    {
      ...
      {
        std::vector<RKInPerInstanceAttributesAtoms> atomData = object->renderSelectedCrystalPrimitivePolygonalPrismObjects();
...
void OpenGLCrystalPolygonalPrismSelectionInstanceShader::reloadData()
{
