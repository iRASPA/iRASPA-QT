...
class OpenGLCrystalCylinderObjectSelectionStripesShader: public OpenGLShader
{
public:
  OpenGLCrystalCylinderObjectSelectionStripesShader(OpenGLCrystalCylinderSelectionInstanceShader &instanceShader, OpenGLCrystalCylinderObjectShader &crystalCylinderShader);
