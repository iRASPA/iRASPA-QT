...
class OpenGLCrystalPolygonalPrismObjectPickingShader: public OpenGLShader
{
public:
  OpenGLCrystalPolygonalPrismObjectPickingShader(OpenGLObjectShader &objectShader);
