...
OpenGLCrystalEllipsoidSelectionInstanceShader::OpenGLCrystalEllipsoidSelectionInstanceShader()
{

}

void OpenGLCrystalEllipsoidSelectionInstanceShader::setRenderStructures(std::vector<std::vector<std::shared_ptr<RKRenderStructure>>> structures)
{
  deleteBuffers();
...
void OpenGLCrystalEllipsoidSelectionInstanceShader::deleteBuffers()
{
...
void OpenGLCrystalEllipsoidSelectionInstanceShader::generateBuffers()
{
...
void OpenGLCrystalEllipsoidSelectionInstanceShader::initializeVertexArrayObject()
{
  for(size_t i=0;i<_renderStructures.size();i++)
  {
    for(size_t j=0;j<_renderStructures[i].size();j++)
    {
      ...
      {
        std::vector<RKInPerInstanceAttributesAtoms> atomData = object->renderSelectedCrystalPrimitiveEllipsoidObjects();
...
void OpenGLCrystalEllipsoidSelectionInstanceShader::reloadData()
{
