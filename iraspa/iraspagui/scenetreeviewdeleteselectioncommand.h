...
{
public:
  SceneTreeViewDeleteSelectionCommand(MainWindow *mainWindow, SceneTreeView *sceneTreeView, std::weak_ptr<FrameListViewModel> frameListViewModel, std::shared_ptr<ProjectStructure> projectStructure,
                                      std::shared_ptr<SceneList> sceneList, std::vector<std::shared_ptr<Movie> > movies,
