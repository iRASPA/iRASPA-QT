...
RenderViewTranslatePositionsCartesianSubCommand::RenderViewTranslatePositionsCartesianSubCommand(MainWindow *mainWindow, std::shared_ptr<iRASPAStructure> iraspaStructure, double3 translation, QUndoCommand *parent):
  QUndoCommand(parent),
...
void RenderViewTranslatePositionsCartesianSubCommand::redo()
{
  ...
  std::vector<std::pair<std::shared_ptr<SKAsymmetricAtom>, double3>> translatedPositions = _iraspaStructure->structure()->translatedPositionsSelectionCartesian(atoms, _translation);
