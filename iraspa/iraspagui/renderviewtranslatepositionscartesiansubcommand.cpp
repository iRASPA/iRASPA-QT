...
RenderViewTranslatePositionsCartesianSubCommand::RenderViewTranslatePositionsCartesianSubCommand(MainWindow *mainWindow, std::shared_ptr<iRASPAObject> iraspaStructure, double3 translation, QUndoCommand *parent):
  QUndoCommand(parent),
