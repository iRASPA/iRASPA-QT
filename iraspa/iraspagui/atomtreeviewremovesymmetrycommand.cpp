...
AtomTreeViewRemoveSymmetryCommand::AtomTreeViewRemoveSymmetryCommand(MainWindow *mainWindow, AtomTreeViewModel *model, std::shared_ptr<iRASPAStructure> iraspa_structure,
...
{
  std::shared_ptr<Structure> structure = _iraspa_structure->structure()->removeSymmetry();
