...
FrameListViewDropMoveCommand::FrameListViewDropMoveCommand(MainWindow *mainWindow, FrameListViewModel *frameListViewModel,
  ...
  _newSelection({})
{
  ...
  setText(QString("Reorder frames(s)"));
}

void FrameListViewDropMoveCommand::redo()
{
  _reverseMoves.clear();
  _newSelection.clear();
...
void FrameListViewDropMoveCommand::undo()
{
  _frameListViewModel->layoutAboutToBeChanged();
