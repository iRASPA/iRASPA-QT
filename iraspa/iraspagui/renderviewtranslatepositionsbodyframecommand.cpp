...
RenderViewTranslatePositionsBodyFrameCommand::RenderViewTranslatePositionsBodyFrameCommand(MainWindow *mainWindow, std::shared_ptr<ProjectStructure> projectStructure, std::vector<std::vector<std::shared_ptr<iRASPAStructure>>> iraspaStructures, double3 translation, QUndoCommand *parent):
  QUndoCommand(parent),
...
void RenderViewTranslatePositionsBodyFrameCommand::redo()
{
  QUndoCommand::redo();
...
void RenderViewTranslatePositionsBodyFrameCommand::undo()
{
  QUndoCommand::undo();
