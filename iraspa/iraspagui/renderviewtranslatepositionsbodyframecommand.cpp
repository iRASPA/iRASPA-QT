...
RenderViewTranslatePositionsBodyFrameCommand::RenderViewTranslatePositionsBodyFrameCommand(MainWindow *mainWindow, std::shared_ptr<ProjectStructure> projectStructure, std::vector<std::vector<std::shared_ptr<iRASPAObject>>> iraspaStructures, double3 translation, QUndoCommand *parent):
  QUndoCommand(parent),
