...
{
public:
  SceneTreeViewInsertMovieCommand(MainWindow *mainWindow, SceneTreeView *sceneTreeView, std::weak_ptr<FrameListViewModel> frameListViewModel,
                                  std::shared_ptr<ProjectStructure> projectStructure,
                                  std::shared_ptr<SceneList> sceneList, std::shared_ptr<Movie> movie, std::shared_ptr<Scene> parent, int row,
