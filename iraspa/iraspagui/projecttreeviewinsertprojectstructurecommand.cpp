...
ProjectTreeViewInsertProjectStructureCommand::ProjectTreeViewInsertProjectStructureCommand(MainWindow *mainWindow, ProjectTreeView *projectTreeView,
  ...
  _selection(selection)
{
  ...
  _newItem = std::make_shared<ProjectTreeNode>("New project", iraspaproject, true, true);
}
