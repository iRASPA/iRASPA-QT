...
void BondListViewChangeSelectionCommand::redo()
{
  ...
  {
    bondListController->setSelectionIndexSet(_bondSelection);
  }
...
void BondListViewChangeSelectionCommand::undo()
{
  qDebug() << "Undoing BondTreeViewChangeSelectionCommand";

  if(std::shared_ptr<SKBondSetController> bondListController = _bondListController.lock())
  {
    bondListController->setSelectionIndexSet(_previousBondSelection);
  }
