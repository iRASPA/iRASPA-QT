...
class AtomTreeViewFindPrimitiveCommand : public QUndoCommand
{
public:
  AtomTreeViewFindPrimitiveCommand(MainWindow *mainWindow, std::shared_ptr<iRASPAStructure> iraspaStructure,
