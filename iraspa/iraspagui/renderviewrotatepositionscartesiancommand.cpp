...
RenderViewRotatePositionsCartesianCommand::RenderViewRotatePositionsCartesianCommand(MainWindow *mainWindow, std::shared_ptr<ProjectStructure> projectStructure, std::vector<std::vector<std::shared_ptr<iRASPAObject>>> iraspaStructures, simd_quatd rotation, QUndoCommand *parent):
  QUndoCommand(parent),
