...
{
public:
  AtomTreeViewMakeSuperCellCommand(MainWindow *mainWindow, AtomTreeViewModel *model, std::shared_ptr<iRASPAObject> iraspa_structure, QUndoCommand *undoParent = nullptr);
