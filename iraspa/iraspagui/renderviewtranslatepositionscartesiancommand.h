...
class RenderViewTranslatePositionsCartesianCommand : public QUndoCommand
{
public:
  RenderViewTranslatePositionsCartesianCommand(MainWindow *mainWindow, std::shared_ptr<ProjectStructure> projectStructure,
