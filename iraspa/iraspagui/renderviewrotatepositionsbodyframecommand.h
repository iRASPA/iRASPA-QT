...
class RenderViewRotatePositionsBodyFrameCommand : public QUndoCommand
{
public:
  RenderViewRotatePositionsBodyFrameCommand(MainWindow *mainWindow, std::shared_ptr<ProjectStructure> projectStructure,
