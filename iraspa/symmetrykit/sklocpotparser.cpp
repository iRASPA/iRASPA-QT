...
SKLOCPOTParser::SKLOCPOTParser(QUrl url, bool proteinOnlyAsymmetricUnitCell, bool asMolecule, CharacterSet charactersToBeSkipped): SKParser(),
...
void SKLOCPOTParser::startParsing() noexcept(false)
{
  double3x3 unitCell{};
