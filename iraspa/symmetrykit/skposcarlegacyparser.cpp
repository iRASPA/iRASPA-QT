...
SKPOSCARLegacyParser::SKPOSCARLegacyParser(QString fileContent, bool onlyAsymmetricUnitCell, bool asMolecule, CharacterSet charactersToBeSkipped, LogReporting *log): SKParser(),
...
bool SKPOSCARLegacyParser::startParsing()
{
  double3x3 unitCell{};
