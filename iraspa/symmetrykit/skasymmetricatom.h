...
public:
    ...
    SKAsymmetricAtom(QString displayName, int elementIdentifier, double occupancy);
    ...
    double3 displacement() const  {return _displacement;}
    void setDisplacement(double3 newValue)  {_displacement = newValue;}
