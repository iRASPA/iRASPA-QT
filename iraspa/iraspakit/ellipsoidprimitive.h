...
class EllipsoidPrimitive: public Primitive, public RKRenderPrimitiveEllipsoidObjectsSource
{
public:
  EllipsoidPrimitive();
  ...
  // ===============================================================================================
  EllipsoidPrimitive(const std::shared_ptr<Object> object);
  ...
  // Protocol:  RKRenderPrimitiveEllipsoidObjectsSource
  // ===============================================================================================
