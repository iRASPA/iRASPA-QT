...
class CylinderPrimitive: public Primitive, public RKRenderPrimitiveCylinderObjectsSource
{
public:
  CylinderPrimitive();
  ...
  // ===============================================================================================
  CylinderPrimitive(const std::shared_ptr<Object> object);
  ...
  // Protocol:  RKRenderPrimitiveCylinderObjectsSource
  // ===============================================================================================
