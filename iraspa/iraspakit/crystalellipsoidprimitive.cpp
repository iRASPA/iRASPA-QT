...
CrystalEllipsoidPrimitive::CrystalEllipsoidPrimitive(std::shared_ptr<Structure> s): Primitive(s)
{
...
std::shared_ptr<Structure> CrystalEllipsoidPrimitive::appliedCellContentShift() const
{
  // use the copy constructor
  std::shared_ptr<CrystalEllipsoidPrimitive> ellipsoidCrystal = std::make_shared<CrystalEllipsoidPrimitive>(static_cast<const CrystalEllipsoidPrimitive&>(*this));
