...
class DNACrystal: public Structure, public SpaceGroupViewer,
...
public:
  DNACrystal();
  DNACrystal(const DNACrystal &proteinCrystal);
  DNACrystal(std::shared_ptr<SKStructure> frame);

  ~DNACrystal() {}

  // Object
  // ===============================================================================================
  DNACrystal(const std::shared_ptr<Object> object);
  ObjectType structureType() override final { return ObjectType::dnaCrystal; }
  ...
  // ===============================================================================================
  bool drawAtoms() const override final {return _drawAtoms;}
...
private:
  ...
  friend QDataStream &operator<<(QDataStream &, const std::shared_ptr<DNACrystal> &);
  friend QDataStream &operator>>(QDataStream &, std::shared_ptr<DNACrystal> &);
};
