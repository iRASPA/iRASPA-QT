...
public:
  ...
  Scene(const QUrl url, const SKColorSets& colorSets, ForceFieldSets &forcefieldSets, bool proteinOnlyAsymmetricUnit, bool asMolecule, bool separatePolymerChains = false) noexcept(false);
