...
class Crystal: public Structure, public SpaceGroupViewer, public UnitCellEditor,
...
public:
  ...
  // ===============================================================================================
  Crystal(const std::shared_ptr<Object> object);
  ...
  bool clipAtomsAtUnitCell() const override final;
  ...
  bool clipBondsAtUnitCell() const override final;
