...
VASPDensityVolume::VASPDensityVolume(): Structure()
{

}

VASPDensityVolume::VASPDensityVolume(const std::shared_ptr<Object> object): Structure(object)
{
...
std::shared_ptr<Object> VASPDensityVolume::shallowClone()
{
  return std::make_shared<VASPDensityVolume>(static_cast<const VASPDensityVolume&>(*this));
}

VASPDensityVolume::VASPDensityVolume(std::shared_ptr<SKStructure> frame): Structure(frame)
{
  expandSymmetry();
  _atomsTreeController->setTags();
...
SKBoundingBox VASPDensityVolume::boundingBox() const
{
...
void VASPDensityVolume::reComputeBoundingBox()
{
...
std::vector<RKInPerInstanceAttributesAtoms> VASPDensityVolume::renderAtoms() const
{
...
std::vector<RKInPerInstanceAttributesBonds> VASPDensityVolume::renderInternalBonds() const
{
  int minimumReplicaX = _cell->minimumReplicaX();
  int minimumReplicaY = _cell->minimumReplicaY();
  int minimumReplicaZ = _cell->minimumReplicaZ();
...
std::vector<RKInPerInstanceAttributesBonds> VASPDensityVolume::renderExternalBonds() const
{
  int minimumReplicaX = _cell->minimumReplicaX();
  int minimumReplicaY = _cell->minimumReplicaY();
  int minimumReplicaZ = _cell->minimumReplicaZ();
...
void VASPDensityVolume::expandSymmetry()
{
  std::vector<std::shared_ptr<SKAtomTreeNode>> asymmetricAtomNodes = _atomsTreeController->flattenedLeafNodes();
...
void VASPDensityVolume::expandSymmetry(std::shared_ptr<SKAsymmetricAtom> asymmetricAtom)
{
  std::vector<std::shared_ptr<SKAtomCopy>> atomCopies = std::vector<std::shared_ptr<SKAtomCopy>>{};
...
std::vector<RKInPerInstanceAttributesAtoms> VASPDensityVolume::renderUnitCellSpheres() const
{
  int minimumReplicaX = _cell->minimumReplicaX();
  int minimumReplicaY = _cell->minimumReplicaY();
  int minimumReplicaZ = _cell->minimumReplicaZ();
...
std::vector<RKInPerInstanceAttributesBonds> VASPDensityVolume::renderUnitCellCylinders() const
{
  int minimumReplicaX = _cell->minimumReplicaX();
  int minimumReplicaY = _cell->minimumReplicaY();
  int minimumReplicaZ = _cell->minimumReplicaZ();
...
std::vector<RKInPerInstanceAttributesAtoms> VASPDensityVolume::renderSelectedAtoms() const
{
  int minimumReplicaX = _cell->minimumReplicaX();
  int minimumReplicaY = _cell->minimumReplicaY();
  int minimumReplicaZ = _cell->minimumReplicaZ();
...
std::set<int> VASPDensityVolume::filterCartesianAtomPositions(std::function<bool(double3)> & closure)
{
  std::set<int> data;
...
std::vector<RKInPerInstanceAttributesText> VASPDensityVolume::atomTextData(RKFontAtlas *fontAtlas) const
{
  int minimumReplicaX = _cell->minimumReplicaX();
  int minimumReplicaY = _cell->minimumReplicaY();
  int minimumReplicaZ = _cell->minimumReplicaZ();
...
std::vector<float> VASPDensityVolume::gridData()
{
...
std::vector<float4> VASPDensityVolume::gridValueAndGradientData()
{
   auto *p = reinterpret_cast<float*>(_data.data());
...
double VASPDensityVolume::bondLength(std::shared_ptr<SKBond> bond) const
{
...
double3 VASPDensityVolume::bondVector(std::shared_ptr<SKBond> bond) const
{
  double3 pos1 = bond->atom1()->position();
  double3 pos2 = bond->atom2()->position();
  double3 ds = pos2 - pos1;
...
std::pair<double3, double3> VASPDensityVolume::computeChangedBondLength(std::shared_ptr<SKBond> bond, double bondLength) const
{
  double3 pos1 = bond->atom1()->position();
...
void VASPDensityVolume::computeBonds()
{
  std::vector<std::shared_ptr<SKAtomCopy>> copies = _atomsTreeController->atomCopies();
  SKBondCellList::assignPeriodicFractionalBonds(copies, *_bondSetController, *_cell);
}
