...
class CrystalPolygonalPrismPrimitive: public Primitive, public RKRenderCrystalPrimitivePolygonalPrimsObjectsSource, public RKRenderUnitCellSource
{
public:
  ...
  // ===============================================================================================
  CrystalPolygonalPrismPrimitive(const std::shared_ptr<Object> object);
