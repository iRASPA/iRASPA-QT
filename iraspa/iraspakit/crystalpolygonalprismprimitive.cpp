...
std::vector<RKInPerInstanceAttributesAtoms> CrystalPolygonalPrismPrimitive::renderUnitCellSpheres() const
{
  int minimumReplicaX = _cell->minimumReplicaX();
  int minimumReplicaY = _cell->minimumReplicaY();
  int minimumReplicaZ = _cell->minimumReplicaZ();
...
std::vector<RKInPerInstanceAttributesBonds> CrystalPolygonalPrismPrimitive::renderUnitCellCylinders() const
{
  int minimumReplicaX = _cell->minimumReplicaX();
  int minimumReplicaY = _cell->minimumReplicaY();
  int minimumReplicaZ = _cell->minimumReplicaZ();
...
std::vector<RKInPerInstanceAttributesAtoms> CrystalPolygonalPrismPrimitive::renderSelectedCrystalPrimitivePolygonalPrismObjects() const
{
  std::vector<RKInPerInstanceAttributesAtoms> atomData;
...
std::set<int> CrystalPolygonalPrismPrimitive::filterCartesianAtomPositions(std::function<bool(double3)> & closure)
{
  std::set<int> data;
...
void CrystalPolygonalPrismPrimitive::reComputeBoundingBox()
{
...
std::shared_ptr<Primitive> CrystalPolygonalPrismPrimitive::superCell() const
{
...
std::shared_ptr<Primitive> CrystalPolygonalPrismPrimitive::flattenHierarchy() const
{
...
std::shared_ptr<Primitive> CrystalPolygonalPrismPrimitive::appliedCellContentShift() const
{
  // use the copy constructor
  std::shared_ptr<CrystalPolygonalPrismPrimitive> polygonalPrismCrystal = std::make_shared<CrystalPolygonalPrismPrimitive>(static_cast<const CrystalPolygonalPrismPrimitive&>(*this));
  //polygonalPrismCrystal->_spaceGroup = this->_spaceGroup;
  ...
  streamRead >> polygonalPrismCrystal->_atomsTreeController;

  const std::vector<std::shared_ptr<SKAtomTreeNode>> asymmetricAtomNodes = polygonalPrismCrystal->atomsTreeController()->flattenedLeafNodes();
  ...
  polygonalPrismCrystal->expandSymmetry();
  polygonalPrismCrystal->setCell(std::make_shared<SKCell>(*_cell));
  polygonalPrismCrystal->cell()->setContentFlip(bool3(false,false,false));
  polygonalPrismCrystal->cell()->setContentShift(double3(0.0,0.0,0.0));
  polygonalPrismCrystal->atomsTreeController()->setTags();
  polygonalPrismCrystal->reComputeBoundingBox();
 // polygonalPrismCrystal->computeBonds();
...
double3 CrystalPolygonalPrismPrimitive::centerOfMassOfSelectionAsymmetricAtoms(std::vector<std::shared_ptr<SKAsymmetricAtom>> asymmetricAtoms) const
{
...
double3x3 CrystalPolygonalPrismPrimitive::matrixOfInertia(std::vector<std::shared_ptr<SKAsymmetricAtom>> atoms) const
{
...
std::vector<std::pair<std::shared_ptr<SKAsymmetricAtom>, double3>> CrystalPolygonalPrismPrimitive::translatedPositionsSelectionCartesian(std::vector<std::shared_ptr<SKAsymmetricAtom>> atoms, double3 translation) const
{
...
std::vector<std::pair<std::shared_ptr<SKAsymmetricAtom>, double3>> CrystalPolygonalPrismPrimitive::translatedPositionsSelectionBodyFrame(std::vector<std::shared_ptr<SKAsymmetricAtom>> atoms, double3 translation) const
{
...
std::vector<std::pair<std::shared_ptr<SKAsymmetricAtom>, double3>> CrystalPolygonalPrismPrimitive::rotatedPositionsSelectionCartesian(std::vector<std::shared_ptr<SKAsymmetricAtom>> atoms, simd_quatd rotation) const
{
  double3 comFrac = centerOfMassOfSelectionAsymmetricAtoms(atoms);
...
std::vector<std::pair<std::shared_ptr<SKAsymmetricAtom>, double3>> CrystalPolygonalPrismPrimitive::rotatedPositionsSelectionBodyFrame(std::vector<std::shared_ptr<SKAsymmetricAtom>> atoms, simd_quatd rotation) const
{
  double3 comFrac = centerOfMassOfSelectionAsymmetricAtoms(atoms);
...
QDataStream &operator>>(QDataStream &stream, std::shared_ptr<CrystalPolygonalPrismPrimitive> &primitive)
{
  ...
  else
  {
    qint64 magicNumber;
    stream >> magicNumber;
    if(magicNumber != qint64(0x6f6b6191))
    {
      throw InvalidArchiveVersionException(__FILE__, __LINE__, "CrystalPolygonalPrismPrimitive invalid magic-number");
    }
