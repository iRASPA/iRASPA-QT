...
class AtomStructureEditor: public AtomStructureViewer
{
public:
  virtual ~AtomStructureEditor() = 0;
  ...
  virtual void updateForceField(ForceFieldSets &forceFieldSets) = 0;   // check if needed
