...
class GaussianCubeVolume: public Structure, public VolumetricDataViewer,
                          public RKRenderUnitCellSource, public RKRenderVolumetricDataSource
{
public:
  GaussianCubeVolume();
  GaussianCubeVolume(std::shared_ptr<SKStructure> frame);

  // Object: reimplemented
  // ===============================================================================================
  GaussianCubeVolume(const std::shared_ptr<Object> object);
  ObjectType structureType() override final { return ObjectType::GaussianCubeVolume; }
...
private:
  ...
  friend QDataStream &operator<<(QDataStream &, const std::shared_ptr<GaussianCubeVolume> &);
  friend QDataStream &operator>>(QDataStream &, std::shared_ptr<GaussianCubeVolume> &);
};
