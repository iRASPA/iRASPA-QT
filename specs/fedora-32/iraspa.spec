...
BuildRequires:  gcc-c++, dbus-devel, qt5-qtbase-devel, qt5-qtwebengine-devel, qt5-qtdeclarative-devel, python3-devel, ffmpeg-devel, xz-devel, zlib-devel, opencl-headers, ocl-icd-devel
