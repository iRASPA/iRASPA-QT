...
BuildRequires:  cmake, gcc-c++, libqt5-qtbase-devel, libqt5-qttools-devel, libqt5-qtwebengine-devel, libqt5-qtdeclarative-devel, python3-devel, ffmpeg-devel, xz-devel, zlib-devel, opencl-headers, ocl-icd-devel
